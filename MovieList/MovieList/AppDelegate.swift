...
//  MovieList
//
//  Created by Julianny Favinha on 11/5/18.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication,
        ...
        window?.tintColor = #colorLiteral(red: 0.5960784314, green: 0.1450980392, blue: 0.5411764706, alpha: 1)

        // setting default preferences
        if UserDefaultsManager.numberOfExecutions() == 0 {
            UserDefaultsManager.setAutoPlay(to: true)
            UserDefaultsManager.setColor(to: 0)
        }
